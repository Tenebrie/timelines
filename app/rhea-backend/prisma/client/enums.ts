...
export const AuditAction = {
  ...
  UserExportDataFailed: 'UserExportDataFailed',
  UserValidateImportData: 'UserValidateImportData',
  UserValidateImportDataFailed: 'UserValidateImportDataFailed',
  UserImportData: 'UserImportData',
  UserImportDataFailed: 'UserImportDataFailed',
