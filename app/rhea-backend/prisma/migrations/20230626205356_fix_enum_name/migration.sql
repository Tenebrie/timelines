/*
  ...
  - The values [EventName] on the enum `WorldEventField` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "WorldEventField_new" AS ENUM ('RevokedAt', 'CustomName', 'EventIcon', 'TargetActors', 'MentionedActors');
