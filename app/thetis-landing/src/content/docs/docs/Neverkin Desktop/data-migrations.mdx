...
description: Move your data between Neverkin environments — how data versions differ from app versions, where Neverkin Desktop stores your data, and how to back it up.
sidebar:
  order: 1
---
